...
class UNetEfficientnet(nn.Module):
    ...
    def __init__(self, num_classes=2, backbone = "b6"):
        super(UNetEfficientnet, self).__init__()
        self.model = getattr(efficientunet, 'get_efficientunet_{}'.format(backbone))(out_channels=num_classes, concat_input=True, pretrained=True)
